                                    ...
                                    <form action="add_user.php" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="form-row mb-4">
                                            <div class="form-group col-md-6">
                                                ...
                                                <input type="text" class="form-control" name="phn1" placeholder="Mobile">
                                            </div>
                                            <div class="form-group col-md-6">
                                                <label for="phn2">Alternate phone</label>
                                                <input type="text" class="form-control" name="phn2" placeholder="Alternate phone">
                                            </div>
                                        </div>
                                        <div class="form-row mb-4">
                                        ...
                                        <div id="login">
                                            <button type="submit" class="btn btn-primary mt-3">Create</button><a
