...
<body class="alt-menu " data-spy="scroll" data-target="#navSection" data-offset="100">
                    ...
                    <div class="modal-content">
                        <form id="driverAssign">
                            ...
                            <div class="modal-body">
                                <div class="col-sm-12 col-12">
                                    <div class="form-group">
                                        ...
                                        <select class="selectpicker form-control" id="driver_id" data-live-search="true" required>
                            ...
                            <div class="modal-footer">
                                ...
                                <button type="submit" class="btn btn-primary" id="asgn-driver">Assign</button>
                            </div>
                        </form>
                    </div>
                </div>
    ...
    $('#driverAssign').on('submit','',function(event){
