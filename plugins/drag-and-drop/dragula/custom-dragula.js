...
})(
  {
    1: [
      function (require, module, exports) {
        ...
        //     if (el.children[0].children[0].children[1].children[2]) {
        //       let currentElem =
        //         el.children[0].children[0].children[1].children[2];
        //       return currentElem.checked === false;
        //     }
        //   },
        // });

        var dragu = dragula([document.getElementById("left-events")], {
          moves: function (el) {
            let currentElem = el.getElementsByClassName("dragBlocker")
            return !currentElem[0].checked;
          },
        });
        dragu
        .on('drag', function (el) {
            ...
            document.getElementById('save_route').setAttribute('disabled','disabled')
        })
