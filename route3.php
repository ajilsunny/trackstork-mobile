                            ...
                            ?>
                                ...
                                <div class="row ml-2 mt-2">
                                    <div class="form-group col-3">
                                        ...
                                        <div>
                                            <input type="checkbox" id="enable_traffic" value="1" disabled></input>
        ...
        $('#save_route').on('click', function() {
            ...
            $.ajax({
                ...
                data:{ fx:32,saveRouteId:saveRouteId,checkedArr:checkedArr,tempLatlong:tempLatlong,whId:warehouseId,wtId:wid,
                       rtwh:rtwh, enTraffic:enTraffic, totalDistance:totalDistance, avgSpeed:avgSpeed, detTime:detTime,totalRouteTime:totalRouteTime,eta:eta,pointDistance:pointDistance  },
