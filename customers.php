            ...
            <div style="width: 100%;padding-right: 15px;padding-left: 15px;margin-right: auto;margin-left: auto;">
                ...
                <div class="page-header">
                    ...
                    <div class="page-title col-md-2">
                        ...
                        <a href="ae_customer.php" class="btn btn-primary pull-right" style="float: right;margin-right: 0px;">
                                ...
                                <div class="widget-header">
                                    <div class="row">
                                        <div class="col-xl-12 col-md-12 col-sm-12 col-12">
                                            <h4 id="formhead">Import Customer</h4>
                                        </div>
                                    </div>
                                </div>
                                <div class="widget-content widget-content-area">
                                    <form form action="upld_cust.php" method="POST" enctype="multipart/form-data">
                                        <div class="custom-file mb-4">
                                            <label class="custom-file-label" for="customFile">Choose file</label>
                                            <input required name="excel" type="file" class="custom-file-input" id="customFile"
                                                accept=".xlsx, application/vnd.openxmlformats-officedocument.spreadsheetml.sheet">
                                            
                                            <small id="sh-text1" class="form-text text-muted mt-4">Upload customer data
                                                in Excel(.xlsx) format. Download sample <a target="_blank"
                                                    class="badge badge-primary"
                                                    href="downloads/customer_sample.xlsx">here</a>.</small>
                                        </div>
                                        <div id="login">
...

                        {
                            ...
                            "render": function(data, type, row) {
                                ...
                                return '<div class="btn-group">' +
                                    '<a href="ae_customer.php?cid=' + data +
