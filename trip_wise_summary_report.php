...
<body class="alt-menu " data-spy="scroll" data-target="#navSection" data-offset="100">
                ...
                <div style="width: 100%;padding-right: 15px;padding-left: 15px;margin-right: auto;margin-left: auto;">
                    <div class="page-header">
                        <div class="page-title col-md-10">
                            <h3>Trip Wise Summary Report</h3>
                        </div>
                    </div>
                            ...
                            <div class="widget-content widget-content-area br-6">
                                ...
                                <form class="dispatch_form" method="post">
                                    <div class="col-12 row">
                                        ...
                                        <div class="col-md-3">
                                            <p for="">Customer</p>
                                            <select name="" id="custm_select" class="form-control">
                                    ...
                                    <div class="col-md-12 mt-3 exel-pdf" style="display:none">
                                        <a href="trip_wise_summary_report_excel.php" class="btn btn-primary">Excel</a>
                                        <a href="trip_wise_summary_report_pdf.php" class="btn btn-primary" target="_blank">PDF</a>
                                    </div>
    ...
    <script>
        ...
        $('.dispatch_form').submit(function (){
            var custm_select=$('#custm_select').val()
            var from=$('#from').val()
            var to=$('#to').val()
            var i=1;
            $.ajax({
        ...
        $.ajax({
            ...
            success: function (data){
                ...
                for (i = 0; i < data.length; i++) {
                    html+='<option value="'+data[i].cust_id+'">'+data[i].cust_name+'</option>';
                }
                $('#custm_select').html(html);
            }
        });
    }
    customer();
