                            ...
                            <div class="widget-content widget-content-area br-6">
                                ...
                                <form class="dispatch_form" method="post">
                                    ...
                                    <div class="col-md-12 mt-3 exel-pdf" style="display:none">
                                        <a href="dispatch_summary_report_excel.php" class="btn btn-primary">Excel</a>
                                        <a href="dispatch_summary_report_pdf.php" class="btn btn-primary" target="_blank">PDF</a>
                                    </div>
