...
function FancyTable($header, $data)
	{
	    ...
	    $this->SetFillColor(15,19,67);
        $this->SetTextColor(255);
        $this->SetDrawColor(15,19,67);
        $this->SetLineWidth(.3);
	    $this->SetFont('Arial','B','10');
	    // Header
	    $w = array(15, 45, 30, 40, 35);
...
function FancyTable5($header, $data)
	...
	function FancyTable6($header, $data)
	{
	    // Colors, line width and bold font
	    $this->SetFillColor(15,19,67);
        $this->SetTextColor(255);
	    ...
	    $this->Cell($w[4],7,$row[4],'LR',0,'C',$fill);
		$this->Cell($w[5],7,$row[5],'LR',0,'C',$fill);
		$this->Cell($w[6],7,$row[6],'LR',0,'C',$fill);
	    $this->Ln();
	    $fill = !$fill;
	    }
	    // Closing line
